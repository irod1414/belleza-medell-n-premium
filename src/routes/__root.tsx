...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Daniela Ortiz — Centro Estético Medellín" },
      ...
      { property: "og:title", content: "Daniela Ortiz — Centro Estético Medellín" },
      ...
      { name: "twitter:title", content: "Daniela Ortiz — Centro Estético Medellín" },
